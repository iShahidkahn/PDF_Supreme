                        ...
                        <div className="content">
                            {pdf ? (
                                <div className="pdf-preview">
                                    ...
                                    <div className="uploaded-buttons" style={{ left: "20%" }}>
                                        {loading2 ? (
                                            <div className="loading-div">
                                                <div className="loading loading-div d-flex justify-content-center align-items-center position-fixed top-0 start-0 w-100 h-100">
                                                    Rotating PDF <div className="spinner-border ms-2"></div>
                                                </div>
                                            </div>
                                        ) : (
                                            <>
                                                    ...
                                                    <span style={{ width: "80px" }}>
                                                        ...
                                                        >
                                                            <path
                                                                fillRule="evenodd"
                                                                fill="white"
                                                                d="M7 8.999A9.986 9.986 0 0 1 15 5c5.523 0 10 4.477 10 10s-4.477 10-10 10a10.003 10.003 0 0 1-9.44-6.694l2.145-.015A8 8 0 1 0 8.07 11l3.93-.001v2H5V6h2v2.999z"
                                                            ></path>
                                                        </svg>
                                                        Rotate Left
                                                    </span>
                                                ...
                                                <button>
                                                    <span style={{ width: "80px" }}>
                                                        ...
                                                        >
                                                            <path
                                                                fillRule="evenodd"
                                                                d="M23 8.999A9.986 9.986 0 0 0 15 5C9.477 5 5 9.477 5 15s4.477 10 10 10c4.283 0 8.048-2.717 9.44-6.694l-2.145-.015A8 8 0 1 1 21.93 11L18 10.999v2h7V6h-2v2.999z"
                                                            ></path>
                                                        </svg>{" "}
                                                        Rotate Right{" "}
                                                    </span>

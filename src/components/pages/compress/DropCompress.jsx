...
const CompressDrop = () => {
  ...
  return (
    <>
      <div className="container drop-compress mt-5">
        <div className="row align-items-center">
          <div className="col-md-6 order-2 order-md-1">
            <p style={{ fontSize: "18px" }}>Reduce the size of your PDFs online easily with our free PDF compressor. Our PDF tools are here to help you get <br /> things done—better, faster, smarter.</p>
            <p>
              <i className="fa-solid fa-check"></i>Reduce file size up to 99% <br />
              <i className="fa-solid fa-check"></i>GDPR compliant and ISO/IEC 27001 certified <br />
              <i className="fa-solid fa-check"></i>TLS encryption for secure document processing <br />
            </p>
          </div>
          <div className="12 col-md-6 order-1 order-md-2">
            <div className="drop-wrapper-c" >
                          ...
                          {loading2 ? (
                            <div className="loading-div">
                              <div className="loading loading-div d-flex justify-content-center align-items-center position-fixed top-0 start-0 w-100 h-100">
                                Compressing PDF <div className="spinner-border ms-2"></div>
                              </div>
                            </div>
                          ) : (
                            <>
                              ...
                              <button onClick={handleCompress}>
                                Compress PDF <i className="fa-solid fa-arrow-right ms-2"></i>
                              </button>
                            </>
                          )}
                        </div>
            ...
            <div className="uploaded-buttons d-none d-sm-content">
              <div className="btn-group dropdown mt-5 mb-4" style={{ marginLeft: "-13px" }}>
                <button
                  type="button"
                ...
                <ul className="dropdown-menu dropdown-menu-drop">
                  <li>
                    <button className="dropdown-item dropdown-item-drop" onClick={handleDelete}>
                      <i className="fa-solid fa-trash me-2"></i>Delete
                    </button>
                  </li>
                  <li>
                  ...
                  <li>
                    <button className="dropdown-item dropdown-item-drop" onClick={handleCompress}>
                      Compress <i className="fa-solid fa-arrow-right ms-2"></i>
                    </button>
                  </li>
                </ul>
              </div>
      ...
      <div className="modal fade" id="exampleModal" tabIndex={-1} aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable" style={{ maxWidth: 'fit-content', backgroundColor: "tranparent" }}>

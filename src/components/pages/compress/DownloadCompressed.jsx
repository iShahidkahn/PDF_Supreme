                    ...
                    <div className="row no-gutters slider-text align-items-center justify-content-center">
                        <div className="col-md-9 pt-5 text-center">
                            <div className="d-flex align-items-center justify-content-center">
                                ...
                                <h2 className="mb-0 bread protect-h">Compressed Successfuly</h2>
                            </div>
            ...
            <section className='download-box'>
                <div className="inner-box">
                    <div className='d-flex justify-contents-center align-items-center'>
                        <Link to='/compress'>
                            <button type="button" class="btn btn-sm me-3 back" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Back to Compress PDF">
                ...
                <div className="inner-box d-block ms-2">
                    <button type="button" class="btn back-icon btn-sm me-3 d-block" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View compressed PDF">
...
export default DownloadCompressed;
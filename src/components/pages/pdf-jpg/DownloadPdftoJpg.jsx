            ...
            <section className='download-box'>
                <div className="inner-box">
                    <div className='d-flex justify-contents-center align-items-center'>
                        <Link to='/pdf_to_jpg'>
                            <button type="button" class="btn btn-sm me-3 back" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Back to PDF - JPG">
                ...
                <div className="inner-box d-block ms-2">
                    <button type="button" class="btn back-icon btn-sm me-3 d-block" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View JPG">
                        <img src={viewIcon} alt="" />
                    </button>
                    <Link to='/pdf_to_jpg'>
                    <button type="button" class="btn back-icon btn-sm me-3 mt-2 p-2" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Delete it now">
